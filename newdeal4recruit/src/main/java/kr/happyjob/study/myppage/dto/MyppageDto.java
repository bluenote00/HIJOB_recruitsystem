package kr.happyjob.study.myppage.dto;
...
public class MyppageDto {
	...
	public String getAppli_procdate() {
		return appli_procdate;
	}
	public void setAppli_procdate(String appli_procdate) {
	...
	public List<MyppageDto> getSkillist() {
		return skillist;
	}
	public void setSkillist(List<MyppageDto> skillist) {

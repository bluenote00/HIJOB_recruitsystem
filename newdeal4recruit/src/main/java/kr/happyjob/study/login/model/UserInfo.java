...
public class UserInfo {
	...
	public String getUser_cornm() {
		return user_cornm;
	}
	public void setUser_cornm(String user_cornm) {
		this.user_cornm = user_cornm;
	}
	...
	public String getUser_deccnt() {
		return user_deccnt;
	}
	public void setUser_deccnt(String user_deccnt) {
		this.user_deccnt = user_deccnt;
	}

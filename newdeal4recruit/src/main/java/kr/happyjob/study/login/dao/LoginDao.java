...
public interface LoginDao {
	...
	//네이버 사용자 로그인 체크
	public String navercheckLogin(Map<String, Object> paramMap);
	
	/** 사용자 로그인 */
	public LgnInfoModel selectLogin(Map<String, Object> paramMap);
	
	//네이버 사용자 로그인
	public LgnInfoModel naverloginProc(Map<String, Object> paramMap);
	
	//네이버 사용자 로그인
	public LgnInfoModel kakaologinProc(Map<String, Object> paramMap);
	...
	// 네이버 사용자 회원가입
	public int naverRegisterUser(Map<String, Object> paramMap);
	
	// 카카오 사용자 회원가입
	public int kakaoRegisterUser(Map<String, Object> paramMap);

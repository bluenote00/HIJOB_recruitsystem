...
function fn_paperpass(appli_no,corecruit_no,loginID) {
	...
	callAjax("/myppage/Capplicantpaperpassbutton.do", "post", "json", false, param , savecallback);
			    ...
			    <section id="myapply_recruit">
					   	...
					   	<!-- 지원 현황 상세 -->
           				 ...
           				 <div class="mypage_head_recruit">
               					 <h2>지원자 수 총 ${Capplicantcount }명</h2>
            			</div>
             				...
             				<div class="mypage_content">
                					<div class="content_list">
                							...
                							<c:forEach var="item" items="${Capplicantlist }" begin="0" step="1">
                			 							...
                			 							<dl class="applicant_dl">
 																...
 																<dt class="applicant_status_dt">
 																		<a href="/recors/resumeselectoneread.do?resume_no=${item.resume_no}&loginID=${item.loginID}" target="_blank"><span class="applicant_status">이력서 보기</span></a>
 												 							<a href="" id="btnpaperpass" class="btnpaperpass" name="btn" onclick="fn_paperpass('${item.appli_no}','${item.corecruit_no}','${item.loginID}')"><span class="applicant_status">합격</span></a>

...
<script type="text/javascript">
	...
	function handleConfirm() {
		  // Set sessionStorage flag to prevent the popup from appearing
	...
	function fcancleModal() {
		  // Check if the sessionStorage flag is set
	...
	<section id="wrap_area">
		...
		<dl>
			<dt style="background-color: #3cb3eb">
				<strong style="color: #fbe441;">※ 블랙 되었습니다.</strong>
			</dt>
			<dd class="content" style="padding:20px 20px; font-weight: bold;">
				<p style="margin-bottom:10px;">신고 누적으로 <span style="color:red;">블랙</span> 되어 사이트 이용이 <span style="color:red;">제한</span> 됩니다.</p>
				<table class="row">
				...
				<p style="margin-top:20px;">관리자에게 문의 바랍니다.</p>
				<div class="btn_areaC mt30">
					<a href="#" onclick="handleConfirm()"	class="btnType blue"  id="btnClose" name="btn"><span>확인</span></a>
				</div>
			</dd>
		</dl>
